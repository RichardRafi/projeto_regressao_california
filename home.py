...
median_income = st.slider("Renda média (múltiplos de US$ 10k", 0.15, 15.0, 4.5, 0.5)

ocean_proximity = st.selectbox("Proximidade do oceano", df["ocean_proximity"].unique())

median_income_cat = st.number_input("Faixa de renda", value=4)
...
people_per_household = st.number_input("Pessoas por domicílio", value=2)
